...
| --- | --- | --- |
| `REPLACE-WITH-DOMAIN` | the live domain (canonical, OG tags, JSON-LD, robots.txt, sitemap.xml) | ✅ Done — `basis-io.com.au` (custom domain live 2026-09-21; GoDaddy DNS → GitHub Pages) |
